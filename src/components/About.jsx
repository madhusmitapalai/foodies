                ...
                <Row className='p-2'>
                    <Col md="5" sm="12">
                        <div className='about-second-context'>
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <ul>
                                <li>  <i className="fas fa-check "></i> etiam set dolor ac diam volutpat .</li>
                                <li>  <i className="fas fa-check "></i> erat volutpat alliquet imperdiet .</li>
                                <li> <i className="fas fa-check "></i> purus a odio  finibus bibendum .</li>
                            </ul>
                        </div>
                    </Col>
                    <Col md="7" sm="12">
                        <img src={photo} alt='about-second-section' className='about-second-section' />
                    </Col>
                </Row>
            </Container>
        </div>
